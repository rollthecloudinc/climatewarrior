...
export const environment = {
  ...
  mediaSettings: {
    endpointUrl: 'https://us-east-1.climateaware-dev.eco/vertigoapp/media',
    cloudinaryUrl: 'https://api.cloudinary.com/v1_1/dj4vvkgzw',
    uploadPreset: 'i0hm4opm',
    imageUrl: 'https://us-east-1.climateaware-dev.eco/vertigoapp',
  ...
  clientSettings: {
    ...
    redirect_uri: 'https://dev.climatewarrior.eco/auth-callback',
    silent_redirect_uri: 'https://dev.climatewarrior.eco/silent-refresh.html',
    response_type: "code",
...
const x = 'xxxxxxxxxxxxxxxxxxxxxxxsxxxxx';
